...
////----vulnerable---------------------------------------------------------------            
//-----Fix---------------------------------------------------------
            String queryStr2 = "from Transaction transaction where transaction.acctno = :acctno and transaction.date >= :start and transaction.payee like :payee and ABS(transaction.amount) <= :amount and  and transaction.description like :memo and   and transaction.id = :id";
